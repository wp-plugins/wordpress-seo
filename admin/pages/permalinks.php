...
$wpseo_admin_pages->admin_header(__( 'Permalinks', 'wordpress-seo' ), true, true, 'yoast_wpseo_permalinks_options', 'wpseo_permalinks');
...
$wpseo_admin_pages->admin_footer('Permalinks');