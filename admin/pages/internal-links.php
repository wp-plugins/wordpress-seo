...
$wpseo_admin_pages->admin_header(__('Internal Links','wordpress-seo'), false, true, 'yoast_wpseo_internallinks_options', 'wpseo_internallinks');
...
$wpseo_admin_pages->admin_footer('Internal Links');